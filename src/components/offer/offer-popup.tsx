...
const OfferPopup: React.FC<OfferPopupProps> = ({ offer }) => {
	...
	return (
		<div
			className="w-full hover:bg-berlin-grey-light text-left hover:cursor-pointer bg-white shadow-default"
			onClick={() => {
				window.location.href = offer.path;
			}}
		>
			<div className="flex flex-row py-4 mx-4 lg:mx-0 gap-4 p-2">
