...
const OfferDetail: React.FC<OfferDetailProps> = ({ offer }) => {
	...
	return (
		<div className="flex items-center w-full bg-berlin-grey-light hover:bg-berlin-grey-hover relative text-left hover:cursor-pointer mb-6">
			<LocalizedTrackedAnchorLink
				className="w-full h-full pl-[18px] pr-11"
				href={offer.path}
			>
